...
const updateUserAvatar = asyncHandler(async (re1,res) => {
    const avatarLocalPath = req.fle?.path
...
const updateUserCoverImage = asyncHandler(async (re1,res) => {
    const coverImageLocalPath = req.fle?.path
